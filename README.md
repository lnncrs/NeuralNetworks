...
Este repositório reúne aulas práticas e didáticas sobre arquiteturas de redes neurais e classificação com PyTorch. O conteúdo das aulas está em português; os nomes de pastas e arquivos permanecem em inglês para manter uma estrutura técnica consistente.
...
O notebook [Detecção de dispositivo](tools/detect-device.pt-br.ipynb) verifica rapidamente se o PyTorch está usando CPU, CUDA ou MPS. Ele é uma ferramenta opcional e não faz parte da sequência das aulas.
